# original code: https://github.com/zhunzhong07/Random-Erasing
...
parser.add_argument('--schedule', type=int, nargs='+', default=[100, 200, 265],
...
parser.add_argument('--flag', default=-2, type=float, help='feature augmentation layer')
...
parser.add_argument('--gpu', default='0', type=str, help='gpunum')
...
args.manualSeed = 0
numpy.random.seed(args.manualSeed)
...
def main():
    ...
    print(args.arch)
    if args.arch.endswith('resnet_feature'):
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
                    off_pro=args.off_pro,
                    a_max=args.a_max,
                    r_max=args.r_max
                )
    elif args.arch.endswith('wrn_feature'):   
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        # compute output
        outputs = model(inputs,args.flag,args.feature_p,args.scale_turn,args.offset_turn)
