...
class ResNet_feature(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000,off_pro=0.5, a_max=3, r_max=0.7):
    ...
    def forward(self, x, flag=-2, feature_p=0.5,scale_turn=False,offset_turn=False):
        ...
        if self.training and flag == 2:
            x=offset.compose(x,feature_p,scale_turn,offset_turn,self.scale,self.off)#128, 320, 16, 16
...
def resnet_feature(**kwargs):
    """
    Constructs a ResNet model.
    """
    return ResNet_feature(**kwargs)
